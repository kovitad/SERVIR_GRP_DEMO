...
function choosePurpose(value){
  purpose=value;
  const labels={budget:'Prepare a flood-risk budget case',preparedness:'Review flood preparedness',improvement:'Review a candidate evacuation place',urban:'Download building-height footprints for risk mapping',riskmap:'Download a district or sub-district risk map'};
